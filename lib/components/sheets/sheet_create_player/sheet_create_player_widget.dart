...
import 'sheet_create_player_model.dart';
export 'sheet_create_player_model.dart';

class SheetCreatePlayerWidget extends StatefulWidget {
  const SheetCreatePlayerWidget({
    super.key,
    required this.group,
  ...
  @override
  State<SheetCreatePlayerWidget> createState() =>
      _SheetCreatePlayerWidgetState();
}

class _SheetCreatePlayerWidgetState extends State<SheetCreatePlayerWidget> {
  late SheetCreatePlayerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SheetCreatePlayerModel());
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Here you can create a locar player to this group in case they don\'t use the  app',
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              for (int loop1Index = 0;
                                  loop1Index <
                                      _model.futureMatchesInGroup!.length;
                                  loop1Index++) {
