...
import 'component_attendance_picker_model.dart';
export 'component_attendance_picker_model.dart';

class ComponentAttendancePickerWidget extends StatefulWidget {
  const ComponentAttendancePickerWidget({
    super.key,
  ...
  @override
  State<ComponentAttendancePickerWidget> createState() =>
      _ComponentAttendancePickerWidgetState();
}

class _ComponentAttendancePickerWidgetState
    extends State<ComponentAttendancePickerWidget> {
  late ComponentAttendancePickerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentAttendancePickerModel());
