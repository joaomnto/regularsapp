...
import 'row_add_member_model.dart';
export 'row_add_member_model.dart';

class RowAddMemberWidget extends StatefulWidget {
  const RowAddMemberWidget({
    super.key,
    required this.user,
    required this.group,
  });
  ...
  @override
  State<RowAddMemberWidget> createState() => _RowAddMemberWidgetState();
}

class _RowAddMemberWidgetState extends State<RowAddMemberWidget>
    with TickerProviderStateMixin {
  late RowAddMemberModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RowAddMemberModel());
