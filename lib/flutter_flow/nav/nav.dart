...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: PageGroupSettingsWidget.routeName,
          path: PageGroupSettingsWidget.routePath,
          asyncParams: {
            'group': getDoc(['Groups'], GroupsRecord.fromSnapshot),
            'membership':
                getDoc(['Groups', 'Members'], MembersRecord.fromSnapshot),
          },
          builder: (context, params) => PageGroupSettingsWidget(
            group: params.getParam(
              'group',
              ParamType.Document,
            ),
  ...
  GoRoute toRoute(AppStateNotifier appStateNotifier) => GoRoute(
        ...
        redirect: (context, state) {
          ...
          if (requireAuth && !appStateNotifier.loggedIn) {
            ...
            return '/pageCreateAccountSignIn';
          }
          return null;
        },
