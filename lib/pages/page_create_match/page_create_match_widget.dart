...
import 'page_create_match_model.dart';
export 'page_create_match_model.dart';

class PageCreateMatchWidget extends StatefulWidget {
  const PageCreateMatchWidget({
    super.key,
    required this.groupReference,
    required this.group,
    this.newMatchGroupMembers,
    this.match,
  ...
  final List<DocumentReference>? newMatchGroupMembers;
  final MatchesRecord? match;
  final bool? userIsAdmin;

  static String routeName = 'PageCreateMatch';
  static String routePath = '/pageCreateMatch';

  @override
  State<PageCreateMatchWidget> createState() => _PageCreateMatchWidgetState();
}

class _PageCreateMatchWidgetState extends State<PageCreateMatchWidget> {
  late PageCreateMatchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageCreateMatchModel());
