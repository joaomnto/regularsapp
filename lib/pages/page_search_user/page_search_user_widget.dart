...
class PageSearchUserWidget extends StatefulWidget {
  const PageSearchUserWidget({
    super.key,
    required this.group,
  });
  ...
  static String routeName = 'PageSearchUser';
  static String routePath = '/pageSearchUser';

  @override
  State<PageSearchUserWidget> createState() => _PageSearchUserWidgetState();
}

class _PageSearchUserWidgetState extends State<PageSearchUserWidget> {
  late PageSearchUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageSearchUserModel());
